...
"""EXACT VS MPS ENZ"""
# exact_times = np.load("./Data/Exact/Basic/times-nsteps2000.npy")
# exact_currents = np.load("./Data/Exact/ENZ/currents-nsteps2000-nsites10-U0.5-c4.0-F10.0-a4.npy")
# mps_times = np.load("./Data/Tenpy/ENZ/times-nsteps4000.npy")
# mps_currents = np.load("./Data/Tenpy/ENZ/currents-nsteps4000-nsites10-U0.5-c4.0-F10.0-maxdim2000.npy")
#
# plt.plot(exact_times, exact_currents)
# plt.plot(mps_times, mps_currents, ls="dashed")
# plt.show()
