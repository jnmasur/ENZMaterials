...
import logging
logging.basicConfig(level=logging.INFO, filename="./Data/Tenpy/GroundState/U_range.log")
...
Us = np.array([1/8,1/4, 1/2, 1, 2, 4, 8]) * it
times = []
...
np.save("./Data/Tenpy/GroundState/times-U_range.npy", times)
#
# plt.plot(Us, times)
